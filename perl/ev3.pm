...
*get_port_port_inx = *ev3c::get_port_port_inx;
...
*get_tacho_encoder_mode = *ev3c::get_tacho_encoder_mode;
*set_tacho_encoder_mode = *ev3c::set_tacho_encoder_mode;
*get_tacho_encoder_modes = *ev3c::get_tacho_encoder_modes;
*get_tacho_estop = *ev3c::get_tacho_estop;
*set_tacho_estop = *ev3c::set_tacho_estop;
*get_tacho_log = *ev3c::get_tacho_log;
*get_tacho_polarity_mode = *ev3c::get_tacho_polarity_mode;
*set_tacho_polarity_mode = *ev3c::set_tacho_polarity_mode;
*get_tacho_polarity_modes = *ev3c::get_tacho_polarity_modes;
...
*get_tacho_position_modes = *ev3c::get_tacho_position_modes;
...
*get_tacho_regulation_modes = *ev3c::get_tacho_regulation_modes;
*set_tacho_regulation_modes = *ev3c::set_tacho_regulation_modes;
...
*get_tacho_run_modes = *ev3c::get_tacho_run_modes;
...
*get_dc_command_inx = *ev3c::get_dc_command_inx;
...
*HT_NXT_SMUX_PORT__BASE_ = *ev3c::HT_NXT_SMUX_PORT__BASE_;
*HT_NXT_SMUX_PORT_1 = *ev3c::HT_NXT_SMUX_PORT_1;
*HT_NXT_SMUX_PORT_2 = *ev3c::HT_NXT_SMUX_PORT_2;
*HT_NXT_SMUX_PORT_3 = *ev3c::HT_NXT_SMUX_PORT_3;
*HT_NXT_SMUX_PORT_4 = *ev3c::HT_NXT_SMUX_PORT_4;
*LEGOEV3_INPUT_PORT__BASE_ = *ev3c::LEGOEV3_INPUT_PORT__BASE_;
*LEGOEV3_INPUT_PORT_1 = *ev3c::LEGOEV3_INPUT_PORT_1;
*INPUT_1 = *ev3c::INPUT_1;
*LEGOEV3_INPUT_PORT_2 = *ev3c::LEGOEV3_INPUT_PORT_2;
*INPUT_2 = *ev3c::INPUT_2;
*LEGOEV3_INPUT_PORT_3 = *ev3c::LEGOEV3_INPUT_PORT_3;
*INPUT_3 = *ev3c::INPUT_3;
*LEGOEV3_INPUT_PORT_4 = *ev3c::LEGOEV3_INPUT_PORT_4;
*INPUT_4 = *ev3c::INPUT_4;
*LEGOEV3_OUTPUT_PORT__BASE_ = *ev3c::LEGOEV3_OUTPUT_PORT__BASE_;
*LEGOEV3_OUTPUT_PORT_A = *ev3c::LEGOEV3_OUTPUT_PORT_A;
*OUTPUT_A = *ev3c::OUTPUT_A;
*LEGOEV3_OUTPUT_PORT_B = *ev3c::LEGOEV3_OUTPUT_PORT_B;
*OUTPUT_B = *ev3c::OUTPUT_B;
*LEGOEV3_OUTPUT_PORT_C = *ev3c::LEGOEV3_OUTPUT_PORT_C;
*OUTPUT_C = *ev3c::OUTPUT_C;
*LEGOEV3_OUTPUT_PORT_D = *ev3c::LEGOEV3_OUTPUT_PORT_D;
*OUTPUT_D = *ev3c::OUTPUT_D;
*MS_EV3_SMUX_PORT__BASE_ = *ev3c::MS_EV3_SMUX_PORT__BASE_;
*MS_EV3_SMUX_PORT_1 = *ev3c::MS_EV3_SMUX_PORT_1;
*MS_EV3_SMUX_PORT_2 = *ev3c::MS_EV3_SMUX_PORT_2;
*MS_EV3_SMUX_PORT_3 = *ev3c::MS_EV3_SMUX_PORT_3;
*MS_EV3_SMUX_PORT_4 = *ev3c::MS_EV3_SMUX_PORT_4;
*WEDO_PORT__BASE_ = *ev3c::WEDO_PORT__BASE_;
*WEDO_PORT_1 = *ev3c::WEDO_PORT_1;
*WEDO_PORT_2 = *ev3c::WEDO_PORT_2;
*WEDO_PORT_3 = *ev3c::WEDO_PORT_3;
*WEDO_PORT_4 = *ev3c::WEDO_PORT_4;
*HT_NXT_SMUX_PORT__COUNT_ = *ev3c::HT_NXT_SMUX_PORT__COUNT_;
*LEGOEV3_INPUT_PORT__COUNT_ = *ev3c::LEGOEV3_INPUT_PORT__COUNT_;
*LEGOEV3_OUTPUT_PORT__COUNT_ = *ev3c::LEGOEV3_OUTPUT_PORT__COUNT_;
*MS_EV3_SMUX_PORT__COUNT_ = *ev3c::MS_EV3_SMUX_PORT__COUNT_;
*WEDO_PORT__COUNT_ = *ev3c::WEDO_PORT__COUNT_;
...
*LEGO_EV3_UART_30 = *ev3c::LEGO_EV3_UART_30;
*LEGO_EV3_UART_32 = *ev3c::LEGO_EV3_UART_32;
*LEGO_EV3_UART_29 = *ev3c::LEGO_EV3_UART_29;
*LEGO_EV3_TOUCH = *ev3c::LEGO_EV3_TOUCH;
*LEGO_EV3_UART_33 = *ev3c::LEGO_EV3_UART_33;
...
*HT_NXT_ANGLE_ACCEL = *ev3c::HT_NXT_ANGLE_ACCEL;
...
*LEGO_EV3_UART_30_US_DIST_CM = *ev3c::LEGO_EV3_UART_30_US_DIST_CM;
*LEGO_EV3_UART_30_US_DIST_IN = *ev3c::LEGO_EV3_UART_30_US_DIST_IN;
*LEGO_EV3_UART_30_US_LISTEN = *ev3c::LEGO_EV3_UART_30_US_LISTEN;
*LEGO_EV3_UART_30_US_SI_CM = *ev3c::LEGO_EV3_UART_30_US_SI_CM;
*LEGO_EV3_UART_30_US_SI_IN = *ev3c::LEGO_EV3_UART_30_US_SI_IN;
*LEGO_EV3_UART_30_US_DC_CM = *ev3c::LEGO_EV3_UART_30_US_DC_CM;
*LEGO_EV3_UART_30_US_DC_IN = *ev3c::LEGO_EV3_UART_30_US_DC_IN;
*LEGO_EV3_UART_32_GYRO_ANG = *ev3c::LEGO_EV3_UART_32_GYRO_ANG;
*LEGO_EV3_UART_32_GYRO_RATE = *ev3c::LEGO_EV3_UART_32_GYRO_RATE;
*LEGO_EV3_UART_32_GYRO_FAS = *ev3c::LEGO_EV3_UART_32_GYRO_FAS;
*LEGO_EV3_UART_32_GYRO_G_AND_A = *ev3c::LEGO_EV3_UART_32_GYRO_G_AND_A;
*LEGO_EV3_UART_32_GYRO_CAL = *ev3c::LEGO_EV3_UART_32_GYRO_CAL;
*LEGO_EV3_UART_29_COL_REFLECT = *ev3c::LEGO_EV3_UART_29_COL_REFLECT;
*LEGO_EV3_UART_29_COL_AMBIENT = *ev3c::LEGO_EV3_UART_29_COL_AMBIENT;
*LEGO_EV3_UART_29_COL_COLOR = *ev3c::LEGO_EV3_UART_29_COL_COLOR;
*LEGO_EV3_UART_29_REF_RAW = *ev3c::LEGO_EV3_UART_29_REF_RAW;
*LEGO_EV3_UART_29_RGB_RAW = *ev3c::LEGO_EV3_UART_29_RGB_RAW;
*LEGO_EV3_UART_29_COL_CAL = *ev3c::LEGO_EV3_UART_29_COL_CAL;
*LEGO_EV3_TOUCH_TOUCH = *ev3c::LEGO_EV3_TOUCH_TOUCH;
*LEGO_EV3_UART_33_IR_PROX = *ev3c::LEGO_EV3_UART_33_IR_PROX;
*LEGO_EV3_UART_33_IR_SEEK = *ev3c::LEGO_EV3_UART_33_IR_SEEK;
*LEGO_EV3_UART_33_IR_REMOTE = *ev3c::LEGO_EV3_UART_33_IR_REMOTE;
*LEGO_EV3_UART_33_IR_REM_A = *ev3c::LEGO_EV3_UART_33_IR_REM_A;
*LEGO_EV3_UART_33_IR_S_ALT = *ev3c::LEGO_EV3_UART_33_IR_S_ALT;
*LEGO_EV3_UART_33_IR_CAL = *ev3c::LEGO_EV3_UART_33_IR_CAL;
...
*RCX_MOTOR_RUN = *ev3c::RCX_MOTOR_RUN;
