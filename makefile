...
D_YU = source/app source/app/ut source/app/debug source/core source/ev3

# -- source directories
D_C = lib source source/app source/app/debug source/app/ut source/core source/core/debug source/core/hardware source/core/ut source/ev3
ifeq ($(EV3),0)
D_C := $(D_C) source/ev3/ev3_link
endif
