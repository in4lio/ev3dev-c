...
/*  ev3_led.h was generated by yup.py (yupp) 0.7b4
    out of ev3_led.yu-h at 2014-09-02 18:23
 *//**
...
EV3_LED_EXT size_t set_led_trigger_index( uint8_t id, uint8_t index );
EV3_LED_EXT uint8_t get_led_trigger_index( uint8_t id );
