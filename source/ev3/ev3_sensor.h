...
/*  ev3_sensor.h was generated by yup.py (yupp) 1.0b4
...
#define EV3_SENSOR_EXT_INIT( dec, init ) \
	dec = init
#define EV3_SENSOR_EXT_C
#define EV3_SENSOR_EXT_C_INIT( dec, init ) \
	dec = init
...
#define EV3_SENSOR_EXT_INIT( dec, init ) \
	extern dec
#ifdef __cplusplus
#define EV3_SENSOR_C "C"
#else
#define EV3_SENSOR_C
#endif
#define EV3_SENSOR_EXT_C extern EV3_SENSOR_C
#define EV3_SENSOR_EXT_C_INIT( dec, init ) \
	extern EV3_SENSOR_C dec
#if __GNUC__ && !__GNUC_STDC_INLINE__
#define EV3_SENSOR_INL extern inline
#else
#define EV3_SENSOR_INL inline
#endif
#endif
 ...
 */
EV3_SENSOR_EXT_C EV3_SENSOR ev3_sensor[ SENSOR_DESC__LIMIT_ ];
 ...
 */
EV3_SENSOR_EXT_C size_t get_sensor_address( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_bin_data( uint8_t sn, byte *buf, size_t sz );
 ...
 */
EV3_SENSOR_EXT_C size_t set_sensor_bin_data( uint8_t sn, byte *value, size_t sz );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_bin_data( uint8_t *sn, byte *value, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_bin_data_format( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_command( uint8_t sn, char *value );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_command( uint8_t *sn, char *value );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_commands( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_direct( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_direct( uint8_t sn, char *value );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_direct( uint8_t *sn, char *value );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_decimals( uint8_t sn, dword *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_driver_name( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_fw_version( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_mode( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_mode( uint8_t sn, char *value );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_mode( uint8_t *sn, char *value );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_modes( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_num_values( uint8_t sn, dword *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_poll_ms( uint8_t sn, dword *buf );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_poll_ms( uint8_t sn, dword value );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_poll_ms( uint8_t *sn, dword value );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_units( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value0( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value1( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value2( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value3( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value4( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value5( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value6( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value7( uint8_t sn, float *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_text_value( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_value( uint8_t inx, uint8_t sn, int *buf );
 ...
 */
EV3_SENSOR_EXT_C const char *ev3_sensor_type( INX_T type_inx );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C INX_T get_sensor_type_inx( uint8_t sn );
 ...
 *  \return Count of read bytes.
 */
EV3_SENSOR_EXT_C size_t get_sensor_desc( uint8_t sn, EV3_SENSOR *desc );
 ...
 */
EV3_SENSOR_EXT_C EV3_SENSOR *ev3_sensor_desc( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C INX_T ev3_sensor_desc_type_inx( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C uint8_t ev3_sensor_desc_port( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C uint8_t ev3_sensor_desc_extport( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C uint8_t ev3_sensor_desc_addr( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C char *ev3_sensor_port_name( uint8_t sn, char *buf );
 ...
 */
EV3_SENSOR_EXT_C bool ev3_search_sensor( INX_T type_inx, uint8_t *sn, uint8_t from );
 ...
 *  \return Flag - the sensor is found.
 */
EV3_SENSOR_EXT_C bool ev3_search_sensor_plugged_in( uint8_t port, uint8_t extport, uint8_t *sn, uint8_t from );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C const char *ev3_sensor_mode( INX_T mode_inx );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C INX_T get_sensor_mode_inx_of_type( uint8_t sn, INX_T type_inx );
 ...
 */
EV3_SENSOR_EXT_C INX_T get_sensor_mode_inx( uint8_t sn );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_mode_inx( uint8_t sn, INX_T mode_inx );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_mode_inx( uint8_t *sn, INX_T mode_inx );
 ...
 *  \return Requested value.
 */
EV3_SENSOR_EXT_C const char *ev3_sensor_command( INX_T command_inx );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t set_sensor_command_inx( uint8_t sn, INX_T command_inx );
 ...
 *  \return Count of written bytes.
 */
EV3_SENSOR_EXT_C size_t multi_set_sensor_command_inx( uint8_t *sn, INX_T command_inx );

/**
 *  \brief Detect connected sensors.
 *  \return Number of found sensors or -1 in case of an error.
 */
EV3_SENSOR_EXT_C int ev3_sensor_init( void );
...
#undef EV3_SENSOR_EXT
#undef EV3_SENSOR_EXT_INIT
#undef EV3_SENSOR_EXT_C
#undef EV3_SENSOR_EXT_C_INIT
