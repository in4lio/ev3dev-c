...
/*  brick.h was generated by yup.py (yupp) 0.9b4
    out of brick.yu-h 
 *//**
 ...
 *  \return Socket.
 */
BRICK_EXT POOL_T port_to_socket( uint8_t port );
 ...
 */
BRICK_EXT bool brick_init( void );

/**
 *  \brief Uninitialize the EV3 brick.
 */
BRICK_EXT void brick_uninit( void );

/**
 *  \brief Read state of the EV3 brick's keys.
 *  \return State.
 */
BRICK_EXT uint8_t brick_keys( void );
 ...
 */
BRICK_EXT char *sensor_get_address( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT byte *sensor_get_bin_data( POOL_T sock, byte *buf, size_t sz );
 ...
 */
BRICK_EXT bool sensor_set_bin_data( POOL_T pool, byte *value, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_bin_data_format( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool sensor_set_command( POOL_T pool, INX_T command_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_commands( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_direct( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool sensor_set_direct( POOL_T pool, char *value );
 ...
 *  \return Requested value.
 */
BRICK_EXT dword sensor_get_decimals( POOL_T sock, dword defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_driver_name( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_fw_version( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT INX_T sensor_get_mode( POOL_T sock );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool sensor_set_mode( POOL_T pool, INX_T mode_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_modes( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT dword sensor_get_num_values( POOL_T sock, dword defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT dword sensor_get_poll_ms( POOL_T sock, dword defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool sensor_set_poll_ms( POOL_T pool, dword value );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_units( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value0( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value1( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value2( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value3( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value4( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value5( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value6( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT float sensor_get_value7( POOL_T sock, float defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *sensor_get_text_value( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int sensor_get_value( uint8_t inx, POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_dist_cm( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_dist_in( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_listen( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_si_cm( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_si_in( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_dc_cm( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool us_set_mode_us_dc_in( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool gyro_set_mode_gyro_ang( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool gyro_set_mode_gyro_rate( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool gyro_set_mode_gyro_fas( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool gyro_set_mode_gyro_g_and_a( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool gyro_set_mode_gyro_cal( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_col_reflect( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_col_ambient( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_col_color( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_ref_raw( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_rgb_raw( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool color_set_mode_col_cal( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool touch_set_mode_touch( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_prox( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_seek( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_remote( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_rem_a( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_s_alt( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool ir_set_mode_ir_cal( POOL_T pool );
 ...
 */
BRICK_EXT POOL_T sensor_search( INX_T type_inx );
 ...
 */
BRICK_EXT bool sensor_is_plugged( POOL_T pool, INX_T type_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *tacho_get_address( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_command( POOL_T pool, INX_T command_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *tacho_get_commands( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_count_per_rot( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_count_per_m( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_full_travel_count( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *tacho_get_driver_name( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_duty_cycle( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_duty_cycle_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_duty_cycle_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_hold_pid_Kd( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_hold_pid_Kd( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_hold_pid_Ki( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_hold_pid_Ki( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_hold_pid_Kp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_hold_pid_Kp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_max_speed( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT INX_T tacho_get_polarity( POOL_T sock );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_polarity( POOL_T pool, INX_T polarity_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_position( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_position( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_position_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_position_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_ramp_down_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_ramp_down_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_ramp_up_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_ramp_up_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_speed( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_speed_pid_Kd( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_speed_pid_Kd( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_speed_pid_Ki( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_speed_pid_Ki( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_speed_pid_Kp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_speed_pid_Kp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_speed_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_speed_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT FLAGS_T tacho_get_state( POOL_T sock );
 ...
 *  \return Requested value.
 */
BRICK_EXT INX_T tacho_get_stop_action( POOL_T sock );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_stop_action( POOL_T pool, INX_T stop_action_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *tacho_get_stop_actions( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int tacho_get_time_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_time_sp( POOL_T pool, int value );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_run_forever( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_run_to_abs_pos( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_run_to_rel_pos( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_run_timed( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_run_direct( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_stop( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_reset( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_polarity_normal( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_polarity_inversed( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_stop_action_coast( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_stop_action_brake( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool tacho_set_stop_action_hold( POOL_T pool );
 ...
 */
BRICK_EXT POOL_T tacho_search( INX_T type_inx );
 ...
 */
BRICK_EXT bool tacho_is_plugged( POOL_T pool, INX_T type_inx );
 ...
 */
BRICK_EXT bool tacho_is_running( POOL_T pool );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *dc_get_address( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_command( POOL_T pool, INX_T command_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *dc_get_commands( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *dc_get_driver_name( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int dc_get_duty_cycle( POOL_T sock, int defval );
 ...
 *  \return Requested value.
 */
BRICK_EXT int dc_get_duty_cycle_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_duty_cycle_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT INX_T dc_get_polarity( POOL_T sock );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_polarity( POOL_T pool, INX_T polarity_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT FLAGS_T dc_get_state( POOL_T sock );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_stop_action( POOL_T pool, INX_T stop_action_inx );
 ...
 *  \return Requested value.
 */
BRICK_EXT char *dc_get_stop_actions( POOL_T sock, char *buf, size_t sz );
 ...
 *  \return Requested value.
 */
BRICK_EXT int dc_get_ramp_down_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_ramp_down_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int dc_get_ramp_up_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_ramp_up_sp( POOL_T pool, int value );
 ...
 *  \return Requested value.
 */
BRICK_EXT int dc_get_time_sp( POOL_T sock, int defval );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_time_sp( POOL_T pool, int value );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_run_forever( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_run_timed( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_run_direct( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_stop( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_polarity_normal( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_polarity_inversed( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_stop_action_coast( POOL_T pool );
 ...
 *  \return Flag - success operation.
 */
BRICK_EXT bool dc_set_stop_action_brake( POOL_T pool );
 ...
 */
BRICK_EXT POOL_T dc_search( INX_T type_inx );
 ...
 */
BRICK_EXT bool dc_is_plugged( POOL_T pool, INX_T type_inx );
 ...
 */
BRICK_EXT bool dc_is_running( POOL_T pool );

/**
 *  \brief Delay in milliseconds.
 *  \param ms Value.
 */
BRICK_EXT void sleep_ms( uint32_t ms );
