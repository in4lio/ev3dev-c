...
/*  ev3_led.c was generated by yup.py (yupp) 0.7b4
    out of ev3_led.yu-c at 2014-09-02 18:24
 *//**
...
size_t set_led_trigger_index( uint8_t id, uint8_t index )
{
	return set_led_trigger( id, ( char *) led_trigger[ index ]);
}

uint8_t get_led_trigger_index( uint8_t id )
{
	char buf[ 255 ];
	char *p;
	uint8_t i = 0;
