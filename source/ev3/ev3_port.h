...
/*  ev3_port.h was generated by yup.py (yupp) 1.0b4
...
#define EV3_PORT_EXT_INIT( dec, init ) \
	dec = init
#define EV3_PORT_EXT_C
#define EV3_PORT_EXT_C_INIT( dec, init ) \
	dec = init
#define EV3_PORT_INL
#else
...
#define EV3_PORT_C
#endif
#define EV3_PORT_EXT_C extern EV3_PORT_C
#define EV3_PORT_EXT_C_INIT( dec, init ) \
	extern EV3_PORT_C dec
#if __GNUC__ && !__GNUC_STDC_INLINE__
#define EV3_PORT_INL extern inline
#else
#define EV3_PORT_INL inline
#endif
#endif
 ...
 */
EV3_PORT_EXT_C EV3_PORT ev3_port[ PORT_DESC__LIMIT_ ];
 ...
 */
EV3_PORT_EXT_C size_t get_port_address( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_PORT_EXT_C size_t get_port_driver_name( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of read bytes.
 */
EV3_PORT_EXT_C size_t get_port_mode( uint8_t sn, char *buf, size_t sz );
 ...
 */
EV3_PORT_EXT_C size_t set_port_mode( uint8_t sn, char *value );
 ...
 *  \return Count of written bytes.
 */
EV3_PORT_EXT_C size_t multi_set_port_mode( uint8_t *sn, char *value );
 ...
 *  \return Count of read bytes.
 */
EV3_PORT_EXT_C size_t get_port_modes( uint8_t sn, char *buf, size_t sz );
 ...
 *  \return Count of written bytes.
 */
EV3_PORT_EXT_C size_t set_port_set_device( uint8_t sn, char *value );
 ...
 *  \return Count of written bytes.
 */
EV3_PORT_EXT_C size_t multi_set_port_set_device( uint8_t *sn, char *value );
 ...
 *  \return Count of read bytes.
 */
EV3_PORT_EXT_C size_t get_port_status( uint8_t sn, char *buf, size_t sz );
 ...
 */
EV3_PORT_EXT_C const char *ev3_port_type( INX_T type_inx );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C INX_T get_port_type_inx( uint8_t sn );
 ...
 *  \return Count of read bytes.
 */
EV3_PORT_EXT_C size_t get_port_desc( uint8_t sn, EV3_PORT *desc );
 ...
 */
EV3_PORT_EXT_C EV3_PORT *ev3_port_desc( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C INX_T ev3_port_desc_type_inx( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C uint8_t ev3_port_desc_port( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C uint8_t ev3_port_desc_extport( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C uint8_t ev3_port_desc_addr( uint8_t sn );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C char *ev3_port_port_name( uint8_t sn, char *buf );
 ...
 */
EV3_PORT_EXT_C bool ev3_search_port_type( INX_T type_inx, uint8_t *sn, uint8_t from );
 ...
 *  \return Flag - the EV3 port is found.
 */
EV3_PORT_EXT_C bool ev3_search_port_plugged_in( uint8_t port, uint8_t extport, uint8_t *sn, uint8_t from );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C const char *ev3_port_mode( INX_T mode_inx );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C INX_T get_port_mode_inx_of_type( uint8_t sn, INX_T type_inx );
 ...
 */
EV3_PORT_EXT_C INX_T get_port_mode_inx( uint8_t sn );
 ...
 *  \return Count of written bytes.
 */
EV3_PORT_EXT_C size_t set_port_mode_inx( uint8_t sn, INX_T mode_inx );
 ...
 *  \return Count of written bytes.
 */
EV3_PORT_EXT_C size_t multi_set_port_mode_inx( uint8_t *sn, INX_T mode_inx );

/**
 *  \brief Detect connected EV3 ports.
 *  \return Number of found EV3 ports or -1 in case of an error.
 */
EV3_PORT_EXT_C int ev3_port_init( void );
 ...
 */
EV3_PORT_EXT_C uint8_t ev3_search_port( uint8_t port, uint8_t extport );
 ...
 */
EV3_PORT_EXT_C void ev3_parse_port_name( char *name, uint8_t *port, uint8_t *extport, uint8_t *addr );
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT_C char *ev3_port_name( uint8_t port, uint8_t extport, uint8_t addr, char *buf );

/** \} */

#undef EV3_PORT_EXT
#undef EV3_PORT_EXT_INIT
#undef EV3_PORT_EXT_C
#undef EV3_PORT_EXT_C_INIT
#undef EV3_PORT_INL
#undef EV3_PORT_C
#endif
