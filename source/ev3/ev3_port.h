...
/*  ev3_port.h was generated by yup.py (yupp) 0.9b4
 ...
 *  \return Requested value.
 */
EV3_PORT_EXT INX_T get_port_mode_inx_of_type( uint8_t sn, INX_T type_inx );
 ...
 */
EV3_PORT_EXT INX_T get_port_mode_inx( uint8_t sn );
