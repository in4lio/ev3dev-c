...
/*  ev3.c was generated by yup.py (yupp) 0.7b4
    out of ev3.yu-c at 2014-09-02 18:24
 *//**
 *  \file  ev3.c (ev3.yu-c)
...
void ev3_init( void )
{
	udp_ev3_open( ev3_board_addr, ev3_board_port );
}
