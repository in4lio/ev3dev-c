...
/*  ev3_tacho.h was generated by yup.py (yupp) 0.7b4
    out of ev3_tacho.yu-h at 2014-09-02 18:24
 *//**
...
EV3_TACHO_EXT char *get_tacho_type_id_string( uint8_t type_id );

EV3_TACHO_EXT int search_tacho_port( uint8_t type_id );
