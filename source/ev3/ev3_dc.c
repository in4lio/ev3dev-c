...
/*  ev3_dc.c was generated by yup.py (yupp) 0.8b2
    out of ev3_dc.yu-c at 2015-05-07 14:40
 *//**
...
const char *ev3_dc_stop_command( uint8_t stop_command_inx )
{
...
size_t set_dc_stop_command_inx( uint8_t sn, uint8_t stop_command_inx )
{
