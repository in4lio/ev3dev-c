...
/*  ev3.h was generated by yup.py (yupp) 0.7b6
    out of ev3.yu-h at 2014-10-13 18:06
 *//**
 *  \file  ev3.h (ev3.yu-h)
...
/**
 *  \brief Negative result of operation.
 */
#define EV3_NONE  -1
 ...
 *  \return 1 - the local access, 0 - the brick detection is disabled, EV3_NONE - an error has occurred,
 *  or the number of found bricks.
 */
