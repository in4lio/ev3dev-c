...
/*  ev3.h was generated by yup.py (yupp) 0.8b7
    out of ev3.yu-h at 2015-07-22 12:14
 *//**
 *  \file  ev3.h (ev3.yu-h)
 ...
 *  \return Count of written bytes.
 */
EV3_EXT size_t ev3_write_byte( const char *fn, uint8_t value );
 ...
 *  \return Count of read bytes.
 */
EV3_EXT size_t ev3_read_byte( const char *fn, uint8_t *buf );
 ...
 *  \return Count of read bytes.
 */
EV3_EXT size_t ev3_read_keys( uint8_t *buf );
 ...
 */
EV3_EXT int ev3_string_suffix( const char *prefix, char **s, uint32_t *buf );
