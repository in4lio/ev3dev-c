...
/*  ev3_sensor.c was generated by yup.py (yupp) 0.9b1
    out of ev3_sensor.yu-c at 2015-11-11 14:16
 *//**
...
const char *ev3_sensor_mode( INX_T mode_inx )
{
	...
	case PIXY_LEGO_SIG7:
		return "SIG7";
	case PIXY_LEGO_COL_CODE:
		return "COL-CODE";
	case PIXY_LEGO_ANGLE:
		return "ANGLE";
...
INX_T get_sensor_mode_inx( uint8_t sn, INX_T type_inx )
{
	...
	case PIXY_LEGO:
		...
		if ( strcmp( buf, "COL-CODE" ) == 0 ) return PIXY_LEGO_COL_CODE;
		if ( strcmp( buf, "ANGLE" ) == 0 ) return PIXY_LEGO_ANGLE;
