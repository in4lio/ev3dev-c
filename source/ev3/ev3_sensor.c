...
/*  ev3_sensor.c was generated by yup.py (yupp) 0.7b4
    out of ev3_sensor.yu-c at 2014-09-02 18:25
 *//**
...
#define PATH_BIN_DATA  "/sys/class/msensor/sensor" "///" "bin_data"
#define PATH_BIN_DATA_FORMAT  "/sys/class/msensor/sensor" "///" "bin_data_format"
#define PATH_DP  "/sys/class/msensor/sensor" "///" "dp"
#define PATH_FW_VERSION  "/sys/class/msensor/sensor" "///" "fw_version"
#define PATH_I2C_ADDR  "/sys/class/msensor/sensor" "///" "i2c_addr"
#define PATH_MODE  "/sys/class/msensor/sensor" "///" "mode"
#define PATH_MODES  "/sys/class/msensor/sensor" "///" "modes"
#define PATH_NUM_VALUES  "/sys/class/msensor/sensor" "///" "num_values"
#define PATH_POLL_MS  "/sys/class/msensor/sensor" "///" "poll_ms"
#define PATH_PORT_NAME  "/sys/class/msensor/sensor" "///" "port_name"
#define PATH_UNITS  "/sys/class/msensor/sensor" "///" "units"
#define PATH_TYPE_ID  "/sys/class/msensor/sensor" "///" "type_id"
#define PATH_VALUE0  "/sys/class/msensor/sensor" "///" "value0"
#define PATH_VALUE1  "/sys/class/msensor/sensor" "///" "value1"
#define PATH_VALUE2  "/sys/class/msensor/sensor" "///" "value2"
#define PATH_VALUE3  "/sys/class/msensor/sensor" "///" "value3"
#define PATH_VALUE4  "/sys/class/msensor/sensor" "///" "value4"
#define PATH_VALUE5  "/sys/class/msensor/sensor" "///" "value5"
#define PATH_VALUE6  "/sys/class/msensor/sensor" "///" "value6"
#define PATH_VALUE7  "/sys/class/msensor/sensor" "///" "value7"

#define PATH_VALUE  "/sys/class/msensor/sensor" "///" "value"
...
size_t get_sensor_value( uint8_t ind, uint8_t id, int *buf )
{
	char s[] = PATH_VALUE "    ";
	...
	*modp_uitoa10( id, s + PATH_PREF_LEN ) = '/';
	modp_uitoa10( ind, s + PATH_PREF_LEN + 3 + 5 );

	return ev3_read_int( s, buf );
}

char *get_sensor_type_id_string( uint8_t type_id )
{
	switch ( type_id ) {
	case 16:
		return "EV3_TOUCH";
...
int search_sensor_port( uint8_t type_id )
{
	int i;

	for ( i = 0; i < IN__COUNT_; i++ ) {
		if ( ev3_sensor[ i ].detected && ( ev3_sensor[ i ].type_id == type_id )) return ( i );
	}
	return ( EOF );
}
...
int ev3_sensor_init( void )
{
	...
	if ( !ev3_listdir( "/sys/class/msensor", list, sizeof( list ))) return ( EOF );

	p = strtok( list, " " );
	while ( p ) {
		if ( get_string_suffix( "sensor", p, &id )) {
			if ( get_sensor_port_name( id, s, sizeof( s )) && get_string_suffix( "in", s, &port )) {
