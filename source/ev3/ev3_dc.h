...
/*  ev3_dc.h was generated by yup.py (yupp) 0.8b2
    out of ev3_dc.yu-h at 2015-05-07 14:39
 *//**
...
/**
 *  \brief Get "state" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param[out] buf Buffer for result.
 *  \param sz Buffer size.
 *  \return Count of read bytes.
...
/**
 *  \brief Set "stop_command" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param value Attribute value.
...
/**
 *  \brief Get "stop_commands" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param[out] buf Buffer for result.
 *  \param sz Buffer size.
 *  \return Count of read bytes.
...
/**
 *  \brief Get "ramp_down_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param[out] buf Buffer for result.
...
/**
 *  \brief Set "ramp_down_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param value Attribute value.
...
/**
 *  \brief Get "ramp_up_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param[out] buf Buffer for result.
...
/**
 *  \brief Set "ramp_up_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param value Attribute value.
...
/**
 *  \brief Get "time_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param[out] buf Buffer for result.
...
/**
 *  \brief Set "time_sp" attribute of the DC motor.
 *  \param sn Sequence number.
 *  \param value Attribute value.
 ...
 *  \return Requested value.
 */
EV3_DC_EXT const char *ev3_dc_stop_command( uint8_t stop_command_inx );

/**
 *  \brief Set stop_command of the DC motor by index.
 *  \param sn Sequence number.
 *  \param stop_command_inx Index of the DC motor stop_command.
 *  \return Count of written bytes.
 */
EV3_DC_EXT size_t set_dc_stop_command_inx( uint8_t sn, uint8_t stop_command_inx );
