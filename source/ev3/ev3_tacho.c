...
/*  ev3_tacho.c was generated by yup.py (yupp) 0.7b4
    out of ev3_tacho.yu-c at 2014-09-03 13:49
 *//**
...
#define PATH_PREF_LEN  35

#define PATH_DUTY_CYCLE  "/sys/class/tacho-motor//tacho-motor" "///" "duty_cycle"
#define PATH_DUTY_CYCLE_SP  "/sys/class/tacho-motor//tacho-motor" "///" "duty_cycle_sp"
#define PATH_POLARITY_MODE  "/sys/class/tacho-motor//tacho-motor" "///" "polarity_mode"
#define PATH_PORT_NAME  "/sys/class/tacho-motor//tacho-motor" "///" "port_name"
#define PATH_POSITION  "/sys/class/tacho-motor//tacho-motor" "///" "position"
#define PATH_POSITION_MODE  "/sys/class/tacho-motor//tacho-motor" "///" "position_mode"
#define PATH_POSITION_SP  "/sys/class/tacho-motor//tacho-motor" "///" "position_sp"
#define PATH_PULSES_PER_SECOND  "/sys/class/tacho-motor//tacho-motor" "///" "pulses_per_second"
#define PATH_PULSES_PER_SECOND_SP  "/sys/class/tacho-motor//tacho-motor" "///" "pulses_per_second_sp"
#define PATH_RAMP_DOWN_SP  "/sys/class/tacho-motor//tacho-motor" "///" "ramp_down_sp"
#define PATH_RAMP_UP_SP  "/sys/class/tacho-motor//tacho-motor" "///" "ramp_up_sp"
#define PATH_REGULATION_MODE  "/sys/class/tacho-motor//tacho-motor" "///" "regulation_mode"
#define PATH_RESET  "/sys/class/tacho-motor//tacho-motor" "///" "reset"
#define PATH_RUN  "/sys/class/tacho-motor//tacho-motor" "///" "run"
#define PATH_RUN_MODE  "/sys/class/tacho-motor//tacho-motor" "///" "run_mode"
#define PATH_SPEED_REGULATION_D  "/sys/class/tacho-motor//tacho-motor" "///" "speed_regulation_D"
#define PATH_SPEED_REGULATION_I  "/sys/class/tacho-motor//tacho-motor" "///" "speed_regulation_I"
#define PATH_SPEED_REGULATION_K  "/sys/class/tacho-motor//tacho-motor" "///" "speed_regulation_K"
#define PATH_SPEED_REGULATION_P  "/sys/class/tacho-motor//tacho-motor" "///" "speed_regulation_P"
#define PATH_STATE  "/sys/class/tacho-motor//tacho-motor" "///" "state"
#define PATH_STOP_MODE  "/sys/class/tacho-motor//tacho-motor" "///" "stop_mode"
#define PATH_STOP_MODES  "/sys/class/tacho-motor//tacho-motor" "///" "stop_modes"
#define PATH_TIME_SP  "/sys/class/tacho-motor//tacho-motor" "///" "time_sp"
#define PATH_TYPE  "/sys/class/tacho-motor//tacho-motor" "///" "type"
...
int ev3_tacho_init( void )
{
	...
	if ( !ev3_listdir( "/sys/class/tacho-motor/", list, sizeof( list ))) return ( EOF );
		...
		if ( get_str_suffix( "tacho-motor", p, &id )) {
			if ( get_tacho_port_name( id, s, sizeof( s ))) {
				...
				if ( port != EOF ) {
					...
					if ( strcmp( s, "tacho") == 0 ) ev3_tacho[ port ].type_id = 1;
					else
					if ( strcmp( s, "minitacho") == 0 ) ev3_tacho[ port ].type_id = 2;
					else
