...
/*  ev3_tacho.c was generated by yup.py (yupp) 0.8b3
    out of ev3_tacho.yu-c at 2015-06-26 16:33
 *//**
...
const char *ev3_tacho_command( uint8_t command_inx )
{
	switch ( command_inx ) {
...
size_t set_tacho_command_inx( uint8_t sn, uint8_t command_inx )
{
	return set_tacho_command( sn, ( char* ) ev3_tacho_command( command_inx ));
}

const char *ev3_tacho_stop_command( uint8_t stop_command_inx )
{
...
uint8_t get_tacho_stop_command_inx( uint8_t sn, uint8_t type_inx )
{
	char buf[ 64 ];
...
size_t set_tacho_stop_command_inx( uint8_t sn, uint8_t stop_command_inx )
{
